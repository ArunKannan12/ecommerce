...
const warehouseSections = [
  ...
  { label: "Assigned Orders", to: "order-assigning", icon: Truck },
  { label: "Return Requests", to: "returns", icon: Package },
  { label: "Replacement Requests", to: "replacements", icon: Package },
];
    ...
    <div className="flex h-screen bg-gray-100 relative">
      ...
      >
        <div className="p-6 border-b flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-green-600">Warehouse Panel</h1>
